...
const Markets = () => {
  ...
  return <PullToRefresh onRefresh={handleRefresh} className="min-h-screen pt-14"><div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden" dir="rtl">
