...
const About = () => {
  ...
  const stats = [
    { value: "50,000+", label: "متداول نشط", icon: Users },
    { value: "85%+", label: "نسبة النجاح", icon: TrendingUp },
    { value: "24/7", label: "دعم متواصل", icon: MessageCircle },
    { value: "100+", label: "توصية يومياً", icon: Target },
  ];
  ...
  const values = [
    "الشفافية والمصداقية في جميع توصياتنا",
    "التعليم المستمر لتطوير مهارات المتداولين",
    "الدعم الفني السريع والفعال",
    "التحديث المستمر لاستراتيجيات التداول",
    "حماية رأس المال كأولوية قصوى"
  ];

  return (
    <div className="min-h-screen bg-background pt-[calc(env(safe-area-inset-top,0px)+88px)]">
          ...
          <CardContent className="relative">
            <div className="grid gap-3">
              {values.map((value, index) => (
                <div 
                  key={index} 
                  className="flex items-center gap-3 p-4 rounded-xl bg-background/50 border border-primary/20"
                >
